...
typedef enum _postfixop { JiaJia=1, NoNoNo=2 } postfixop_ty;
...
expr_ty _Py_Starred(expr_ty value, expr_context_ty ctx, int lineno, int
                    col_offset, int end_lineno, int end_col_offset, PyArena
                    *arena);
#define Name(a0, a1, a2, a3, a4, a5, a6, a7) _Py_Name(a0, a1, a2, a3, a4, a5, a6, a7)
expr_ty _Py_Name(identifier id, expr_context_ty ctx, postfixop_ty postf, int
                 lineno, int col_offset, int end_lineno, int end_col_offset,
                 PyArena *arena);
